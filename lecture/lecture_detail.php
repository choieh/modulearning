    ...
    <div class="container container-lecture">
        <div class="class__header">
            ...
            <div class="class__info">
                <ul class="badge__wrap">
                    <li><span class="badge">비환급</span></li>
                </ul>
                <h2 class="class__title">[모두의 TALK]<br>정성호의 리얼 법정교육토크쇼<br>직장내 성희롱 예방교육</h2>
                <p class="class__desc">천의 목소리를 가진 SNL크루 정성호와 상큼발랄 매력만점 박하윤 아나운서가 함께하는 직장인 리얼 토크쇼!</p>
                <div class="class__cost">
                    <dl>
                        <div class="cost__item">
                            ...
                            <dd>
                                ...
                                <ul class="cost__list" role="listbox" aria-labelledby="select_lb">
                                    <li id="cost__sort01" role="option" aria-selected="true" tabindex="0">1개월</li>
                                    <li id="cost__sort02" role="option" aria-selected="false" tabindex="0">2개월</li>
                                    <li id="cost__sort03" role="option" aria-selected="false" tabindex="0">3개월</li>
                                </ul>
                            </dd>
                        </div>
                        <div class="cost__item">
        ...
        <div class="class__body">
            ...
            <div class="intro__notice">
                <strong class="notice__title">주문전, 확인해주세요!</strong>
                <div class="notice__desc">
                    <strong>
                        <수강시 유의사항>
                    </strong>
                    <ul>
                        <li>■ 미리보기 수강은 수강시작으로 간주하지 않습니다.</li>
                        <li>■ 콘텐츠의 전체 차시가 3차시 이하일 경우, 1차시의 진도율이 10% 이상이면 수강 완료로 간주하여 환불이 불가합니다.</li>
                        <li>■ 수강기간 종료 후에는 콘텐츠 이용이 불가하오니 수강을 원하시면 결제를 진행해주세요.</li>
                    </ul>
                </div>
            </div>
