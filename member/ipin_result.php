...
//보안을 위해 제공해드리는 샘플페이지는 서비스 적용 후 서버에서 삭제해 주시기 바랍니다. 
  ...
  $sEncData = $_REQUEST['enc_data'];	// ipin_process.php 에서 리턴받은 암호화 된 사용자 인증 정보
...
var m_retCD = '<?=$strResultCode?>';
var m_trnID = '<?=$strCPRequest?>';
//var m_trnDT = '<?=$inputDate?>';
var m_trnDT = '<?=date("Y-m-d H:i:s")?>';

if(result == 'Y'){
    
	opener.parent.mobileCheck(userName,userBirth,sex,m_retCD,m_trnID,m_trnDT,'','M');
