<? 
    ...
    //$LGD_BUYER                  = $_POST["LGD_BUYER"];                           //구매자명
		//$LGD_BUYER                  = $_SESSION["loginUserName"];                           //구매자명
		$LGD_BUYER									= $_POST["LGD_BUYER"];;
    $LGD_PRODUCTINFO            = $_POST["LGD_PRODUCTINFO"];                     //상품명

		//$LGD_PRODUCTINFO            = iconv("utf-8", "utf-8", $_POST["LGD_PRODUCTINFO"]);
...
<!--<input type="text" name="actionInput" value="" onChange="launchCrossPlatform();" />-->
