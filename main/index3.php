	...
	<div class="main_visual" style="height:25px;">
		<div id="slides">
					...
					<div class="slides_container">
						...
						<div class="slide" style="background:url('/images/common/2023_ki_pc.png') 50% 50% no-repeat;"><a href="https://modulearning.kr/trainingCard/" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-기업직업훈련카드"/></a></div>

						<div class="slide" style="background:url('/images/common/offBanner.png') 50% 50% no-repeat;"><a href="https://modulearning.kr/safe/index.php?pid=2" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-관리감독자교육"/></a></div>						
...
<!--						<li class=""><a href="#self">모두의러닝-메인4</a></li>-->
		...
		<script type="text/javascript">
			$(function(){
				...
				const icon = document.getElementById("youtubeIcon");
				...
				icon.addEventListener("mouseleave", () => {
				  ...
				  document.getElementById("video").src = "https://youtu.be/LvLWnaaz9nQ";
				});
			});
		</script>
	</div>
	...
	<div class="bgGray1">
		<ul class="main_banner">
            ...
            <li id="youtubeIcon"><a href="https://youtu.be/LvLWnaaz9nQ" target="_blank"><span class="main_ban7"></span>유튜브</a></li>
	...
	<div id="video-container" style="display: none;">
		<iframe id="video" src="https://youtu.be/LvLWnaaz9nQ" frameborder="0" style="width: 100%; height: 100%;"></iframe>
	</div>
	...
	<div class="bgWhite" >
		<ul class="main_bottom_banner">
			...
			<li>
			<a href="/bbs/?boardCode=1&seq=684" style="cursor:pointer">
	...
	<div class="fix-banner">
		<div class="wrap" style="background: #ffcb05;">
			우리기업에 필요한 교육을 원하신다면?
			<a href="/landing/" class="btn_bform" style="background: #3c3c3c;color: #fff;">상담문의</a>
