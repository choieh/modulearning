...
<script type="text/javascript">
    ...
    <?
    $queryC = "SELECT eduInfoURL FROM nynCompany WHERE companyCode='2728101049'";
    ...
    $_left = 0;
    $contentsType = [
        '1'=>'<span style="background-color: #148CFF;color: #fff;position: relative;border: none; display: inline-block; padding: 1px 4px; border-radius: 5px; text-decoration: none; font-weight: 600; transition: 0.25s;">사업주 환급</span>',
        '2'=>'<span style="background-color: #ff5f2e;color: #fff;position: relative;border: none; display: inline-block; padding: 1px 4px; border-radius: 5px; text-decoration: none; font-weight: 600; transition: 0.25s;">내일배움카드</span>',
        '3'=>'<span style="background-color: #FFB914;color: #fff;position: relative;border: none; display: inline-block; padding: 1px 4px; border-radius: 5px; text-decoration: none; font-weight: 600; transition: 0.25s;">비환급</span>',
        '4'=>'<span style="background-color: #FF4646;color: #fff;position: relative;border: none; display: inline-block; padding: 1px 4px; border-radius: 5px; text-decoration: none; font-weight: 600; transition: 0.25s;">기업직업훈련</span>',
        '5'=>'<span style="background-color: #A33CD6;color: #fff;position: relative;border: none; display: inline-block; padding: 1px 4px; border-radius: 5px; text-decoration: none; font-weight: 600; transition: 0.25s;">Flex</span>'
    ];
...
<!-- 웹마스터 코드 -->
<!-- google -->
<meta name="google-site-verification" content="MuFM-fcXXMlkKLMzrTnUXUmy1bt0kNmf0vylrmHld-c" />
<!-- bing -->
<meta name="msvalidate.01" content="EB2D0CBE50DDC087237ABA0314B295A3" />
<!-- naver -->
<!-- <meta name="naver-site-verification" content="efb329cd0142dacaf771591bd9831b77438e6830" /> -->

<!-- modulearning -->
<meta name="google-site-verification" content="YPhmoIn2fRNBHDrAdwpfgbfnQdM5_RVDABGNp9fOa28" />
<meta name="naver-site-verification" content="c530c9434814cbf240586575179e9d230f311727" />
<!-- -->
<!-- 삭제금지 -->
</head>
<body>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PK297RLF"
    ...
    <div id="container_m" class="main">
        ...
        <div class="main_visual" style="height:25px;">
            <div id="slides">
                ...
                <div class="slides_container">
                    <!-- <div class="slide" style="background:url('/images/common/배우리배너.png') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/landing/ai02/" target="_self"><img src="/images/common/blank.png" alt="AiStudio-배우리"/></a></div> -->

                    <div class="slide" style="background:url('/images/common/bnr_main_h1920.jpg') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/landing/ai02/" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-세상에 없던 새로운 AI휴먼 영상제작 서비스"/></a></div>
                    
                    <div class="slide" style="background:url('/images/common/manage_edu.jpg') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/landing/manager-edu/" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-관리감독자교육"/></a></div>

                    <!-- <div class="slide" style="background:url('/images/common/산업안전보건교육배너2.png') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/landing/indexSAFE.html" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-산업안전보건교육"/></a></div> -->

                    <div class="slide" style="background:url('/images/common/img_bnr_legal-edu.jpg') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/landing/legal-edu/" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-법정의무교육"/></a></div>

                    <div class="slide" style="background:url('/images/common/기직카.png') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/trainingCard/" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-기업직업훈련카드"/></a></div>

                    <div class="slide" style="background:url('/images/common/2023a_pc.png') 50% 50% no-repeat;"><a target="_self"><img src="/images/common/blank.png" alt="모두의러닝-1위"/></a></div>

                    <!-- <div class="slide" style="background:url('/images/common/offBanner.png') 50% 50% no-repeat;"><a href="https://<?=$_siteURL?>/safe/index.php?pid=2" target="_self"><img src="/images/common/blank.png" alt="모두의러닝-관리감독자교육"/></a></div> -->
            ...
            <div class="horizontal_wrap">
                <div class="main_hotcourse">
                    <ul class="horizontal_list">
                        <?
                        $courtSql = mysql_query(" SELECT a.seq, a.previewImage, a.contentsName, a.contentsCode, a.chapter, a.contentsTime, a.price, a.selfPrice, a.contentsType FROM nynContents a WHERE a.mainCourt = 'Y' ");
                            ...
                            <li class="first">
                                ...
                                <a href="/lecture/?seq=<?=$courtRow['seq']?>" title="<?=$courtRow['contentsName']?>">
                                    <div class="list_ccont">
                                        ...
                                        <span class="list_blt">
                                        <p><label>과정유형</label> <?=$contentsType[$courtRow['contentsType']]?> </p>
										<p><label>총차시</label> <?=$courtRow['chapter']?> 차시 </p>
										<p><label>학습시간</label> <?=$courtRow['contentsTime']?> 시간</p>
										<p><label>교육비</label> <?=number_format($courtRow['selfPrice'])?>원</p>
                                            <!-- 180일 -->
									</span>
                                        <span class="list_price"><?=number_format($courtRow['selfPrice'])?>원</span>
                                    </div>
                                </a>
                            </li>
                        <? } ?>
        ...
        <div class="bgGray1">
            <ul class="main_banner">
                ...
                <li><a href="<?= $rsc['eduInfoURL']?>"><span class="main_ban2"></span>교육과정리스트</a></li>
                <li><a href="https://youtu.be/LvLWnaaz9nQ" target="_blank"><span class="main_ban7"></span>유튜브</a></li>
            ...
            <div class="horizontal_wrap">
                <div class="mcourse_recomm" style="display:;">
                    ...
                    <div class="main_course_info" id="mc_recom1">
                        <ul class="horizontal_list">
                            <?
                            $newSql = mysql_query(" SELECT a.seq, a.previewImage, a.contentsName, a.contentsCode, a.chapter, a.contentsTime, a.price, a.selfPrice, a.contentsType FROM nynContents a WHERE a.mainNew = 'Y' ");
								...
								<img src="/attach/contents/<?=$newRow['previewImage']?>" alt="<?=$newRow['contentsName']?>" class="course_image" onerror="ImageError(this, '/images/common/noimage_course.gif');"/>
                                    ...
                                    <a href="/lecture/?seq=<?=$newRow['seq']?>" title="<?=$newRow['contentsName']?>">
                                        <div class="list_ccont">
                                            ...
                                            <span class="list_subtitle"></span>
                                            <span class="list_blt">
                                <p><label>과정유형</label> <?=$contentsType[$newRow['contentsType']]?> </p>
								<p><label>총차시</label> <?=$newRow['chapter']?> 차시 </p>
								<p><label>학습시간</label> <?=$newRow['contentsTime']?> 시간</p>
								<p><label>교육비</label> <?=number_format($newRow['selfPrice'])?>원</p>
                                                <!-- 180일 -->
							</span>
                                            <span class="list_price"><?=number_format($newRow['selfPrice'])?>원</span>
                                        </div>
                                    </a>
                                </li>
                            <? } ?>
        ...
        <div class="bgWhite">
            ...
            <div class="horizontal_wrap">
                <ul class="horizontal_list">
                    ...
                    <?
                    $bestSql = mysql_query(" SELECT a.seq, a.previewImage, a.contentsName, a.contentsCode, a.chapter, a.contentsTime, a.selfPrice, a.contentsType FROM nynContents a WHERE a.mainBest = 'Y' ");
						...
						<a href="/lecture/?seq=<?=$bestRow['seq']?>" title="<?=$bestRow['contentsName']?>" >
                            ...
                            <a href="/lecture/?seq=<?=$bestRow['seq']?>" title="<?=$bestRow['contentsName']?>">
                                <div class="list_ccont">
                                    ...
                                    <span class="list_subtitle"></span>
                                    <span class="list_blt">
                            <p><label>과정유형</label> <?=$contentsType[$bestRow['contentsType']]?> </p>
							<p><label>총차시</label> <?=$bestRow['chapter']?> 차시 </p>
							<p><label>학습시간</label> <?=$bestRow['contentsTime']?> 시간</p>
							<p><label>교육비</label> <?=number_format($bestRow['selfPrice'])?>원</p>
                                        <!-- 180일 -->
						</span>
                                    <span class="list_price"><?=number_format($bestRow['selfPrice'])?>원</span>
                                </div>
                            </a>
                        </li>
                    <? } ?>
        ...
        <div class="bgWhite" >
            <ul class="main_bottom_banner">
                ...
                <li>
                    <a href="/bbs/?boardCode=1&seq=7045" style="cursor:pointer">
        ...
        <style>
            ...
            .fix-banner.fix2 {position:fixed;bottom:30px;left:52.2%;border:none; border-radius: 50%; margin-left:650px;width:60px !important;height:60px !important; background-color: #ffcb05;}
            .fix-banner.fix2 .wrap{display:none;}
            .fix-banner.fix2 .fix_open {display:inline-block; width:60px !important;height:60px !important; border-radius:50%; border:none; background: url('/images/common/fix2.png') no-repeat center;}
        </style>
        <div class="fix-banner">
            <div class="wrap" style="background: #ffcb05;">
                우리기업에 필요한 교육을 원하신다면?
                <a href="/landing/index2.html" class="btn_bform" style="background: #3c3c3c;color: #fff;">상담문의</a>
