        ...
        <div class="bgWhite">
            ...
            <div class="horizontal_wrap">
                <ul class="horizontal_list">
                    ...
                    <?
                    $bestSql = mysql_query(" SELECT a.seq, a.previewImage, a.contentsName, a.contentsCode, a.chapter, a.contentsTime, a.price, a.contentsType FROM nynContents a WHERE a.mainBest = 'Y' ");
