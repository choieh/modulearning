...
<div id="main_contents">
  ...
  <ul>
    <li class="CSCenter" onclick="top.location.href='/bbs/mantomanNew.php'">
    ...
    <li class="BankInfo">
      ...
      <div>
        <img src="../images/main/img_KEB.png" alt="하나은행로고" />
        <h1>하나은행 : 주식회사 모두의러닝</h1>
	...
	<div id="right_quick_con" class="w_con">
		<div class="btn_con">
			<!-- <a href="javascript:move_scroll('info05_con');"> -->
				<img src="/landing/img/quick_con_iconM.png" alt="상담신청" />
				<span>기업교육문의</span>
			<!-- </a> -->
		</div>
