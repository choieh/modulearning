...
<script type="text/javascript" src="../frontScript/userStudyHistory.js?ver=<?=date(ymdhi)?>"></script>
</head>
...
<? include '../include/gnb.php' ?>
  ...
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/study.png);">
      ...
      <h2><?=$_siteName?><img src="../images/global/icon_triangle.png" alt="▶" />내 강의실<img src="../images/global/icon_triangle.png" alt="▶" /><strong>학습 종료 과정</strong></h2>
      <h1>학습 종료 과정</h1>
      <h3 class="study"><strong><?=$_SESSION['loginUserName'] ?></strong>님은 <span>총 <strong class="blue">3</strong>개의 강의를 보셨습니다.</span></h3>
    </div>
    <div id="noticeArea">
      ...
      <div class="noticeArea02" style="margin-left:38px;">
        <h1>안내사항</h1>
        <ul>
          <li>점수확인은 학습종료일이 지난 후, <strong>1주일</strong> 이내에 확인할 수 있습니다.</li>
          <li>수료증 발급은 학습종료일이 지난 후, <strong style="color:red;">1주일</strong> 이내에 출력 가능합니다.</li>
          <li>수료결과보고서(교육증빙자료)는 학습종료일이 지난 후, <strong>2주~3주</strong> 이내에 교육담당자 메일로 발송됩니다.</li>
          <li>미수료로 인한 재수강 문의는 <strong>학습자 회사 내부 교육담당자</strong>에게 확인 부탁드립니다.</li>
        </ul>
