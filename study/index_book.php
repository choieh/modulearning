	...
	var mobileKeyWords = new Array('iPhone', 'iPod', 'BlackBerry', 'Android', 'Windows CE', 'MOT', 'SAMSUNG', 'SonyEricsson');
			for (var word in mobileKeyWords){
				if (navigator.userAgent.match(mobileKeyWords[word]) != null){
						parent.window.location.href='http://m.modulearning.kr';break;
				}
			}
</script>
<!--// 모바일 접근처리 -->
...
var captchaBanStart = '2017-08-24 13:00:00'; //캡챠미적용 시작시간
var captchaBanEnd = '2017-08-24 19:00:00'; //캡챠미적용 끝 시간
...
<script type="text/javascript" src="../frontScript/userStudy_book.js"></script>
</head>
