...
<body id="captcha">
	...
	<form id='formAgent' name='formAgent' method='POST' accept-charset="utf-8">
      ...
      <!-- 훈련기관 ID-->
      <input type='hidden' id='agent_id' 	name='agent_id' value='<?=$_emonID?>' >
      <!-- 회원ID -->
...
<iframe src="https://fds.hrdkorea.or.kr/fdsService/Library/hrdFrame.jsp?agtID=kiraedu&usrID=<?=$_SESSION['loginUserID']?>&sessionID=<?=session_id()?>" width="0" height="0" Style="display:none"/>
</body>
</html>