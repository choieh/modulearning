...
<?
header("Access-Control-Allow-Origin: cont7.modulearning.kr");
//휴대폰 본인인증
...
<script type="text/javascript" src="../frontScript/studyModalTest.js?ver=<?=date(ymdhi)?>"></script>
<script type="text/javascript" src="../frontScript/userStudy.js.bak?ver=<?=date(ymdhi)?>"></script>
