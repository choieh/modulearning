...
<title>한국산업인재융합교육원 - 평가결과보기</title>
...
<script type="text/javascript">
  ...
  $.get(matchingApi,{'contentsCode':contentsCode, 'lectureOpenSeq':lectureOpenSeq, 'testType':testType},function(data){
      ...
      examView += '<h1>안내사항</h1>';
      examView += '<ul>';
      examView += '<li>수고하셨습니다. 채점은 수강기간 종료 이후부터 이루어집니다. <strong>평가 재응시는 불가능</strong>합니다.</li>';
      examView += '<li>성적이의신청은 <strong>1:1게시판</strong>에서 가능합니다.</li>';
      examView += '<li>성적이의신청은 <strong id="lectureEnd">'+data.appeal+'</strong> 까지입니다.</li>';
      examView += '</ul>';
      examView += '</div>';
      examView += '</div>'; 
      ...
      examView += '<h1>안내사항</h1>';
      examView += '<ul>';
      examView += '<li>성적이의신청은 <strong>1:1 게시판</strong>에서 가능하며, 성적이의신청은 <strong>2018년 06월 06일</strong> 까지입니다.</li>';
      examView += '</ul>';
      examView += '</div>';
      examView += '</div>';
