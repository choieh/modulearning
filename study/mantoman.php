...
<script type="text/javascript" src="../frontScript/mantomanView.js?ver=<?=date(ymdhis)?>"></script>
</head>
...
<? include '../include/gnb.php' ?>
  ...
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
      ...
      <h2><?=$_siteName?><img src="../images/global/icon_triangle.png" alt="▶" />내 강의실<img src="../images/global/icon_triangle.png" alt="▶" /><strong>상담신청내역</strong></h2>
      <h1>상담신청내역</h1>
    </div>
    <!-- 동작호출부 -->
