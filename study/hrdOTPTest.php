...
$returnurl = "https://modulearning.kr/member/checkplus_success.php";	// 성공시 이동될 URL
$errorurl = "https://modulearning.kr/member/checkplus_fail.php";		// 실패시 이동될 URL
...
$sReturnURL	= "https://modulearning.kr/member/ipin_process.php"; // 하단내용 참조
$sCPRequest	= ""; // 하단내용 참조
...
<div class="otpVal_wrap_all">
    <a href="https://modulearning.kr/bbs/?boardCode=1&seq=651" target="_blank"><p class="otp_t1" style=""><span>MOTP 매뉴얼 및 설치 링크(클릭)</span></p></a>
</div>
...
//												opener.parent.studyPop('<?=$studySeq?>','<?=$chapter?>','<?=$_GET[viewNew]?>','Y');
                    ...
                    alert('모두의 러닝에 등록되어 있는 핸드폰 번호와 앱에 등록되어있는 핸드폰 번호가 다릅니다. 고객센터로 문의주세요.');
                } else {
...
//				loadingAct();
    ...
    function mobileCheck(userName,userBirth,sex,m_retCD,m_trnID,m_trnDT,mobile_no) {
        var eval_cd = EVAL_CD;
