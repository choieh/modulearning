...
<script type="text/javascript" src="../frontScript/arguementBoardList.js?ver=<?=date(ymdhi)?>"></script>
<script type="text/javascript" src="../frontScript/arguementBoardWrite.js?ver=<?=date(ymdhi)?>"></script>
...
<div id="wrap" class="<? echo $fileName[1] ?>">
  ...
  <div id="contents">
    <div id="titleArea" style="background-image:url(../images/title_bg/<? echo $fileName[1] ?>.png);">
      ...
      <h2><?=$siteName?><img src="../images/global/icon_triangle.png" alt="▶" />토론게시판<img src="../images/global/icon_triangle.png" alt="▶" /><strong></strong></h2>
      <h1></h1>
    </div>
    <!-- 동작호출부 -->
    <div id="contentsArea">
