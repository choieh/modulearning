...
var useApi = '../api/apiEmonProgressNone.php';
...
function listAct(page){
	...
	actionArea += '</div>';
	actionArea += '<strong style="color:red">* 필요한 데이터만 재전송 후 이몬사이트(<a href="https://emon.hrdkorea.or.kr" targat="_black" style="color:red">https://emon.hrdkorea.or.kr</a>)에서 확인해주세요.</strong>';
	actionArea += '</div>';
	actionArea += '</form>'
	actionArea += '</div>';
	...
	contents += '<th style="width:80px;">회원PK(아이디)</th>';
	contents += '<th style="width:80px;">회원이름</th>';
	contents += '<th style="width:120px;">수강기간</th>';
	contents += '<th style="width:100px;">과정PK(과정코드)</th>';
	contents += '<th style="width:100px;">수업PK</th>';	
	contents += '<th style="width:200px;">과정명</th>';	
	contents += '<th style="width:50px;">차시</th>';
	contents += '<th style="width:80px;">진도율</th>';
	contents += '<th style="width:120px;">응시일</th>';
	contents += '<th style="width:80px;">접속IP</th>';
