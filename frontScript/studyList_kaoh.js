...
//   actionArea += '<input type="text" style="width:250px;" name="department">';
	...
	if(loginUserLevel <= 8){
        ...
        if(loginUserLevel <= 4) {
        actionArea += ' <button style="float:right;" type="button" onClick="excelCerti()" >수료증다운로드</button>';
        actionArea += ' <button style="float:right;margin-right: 5px;" type="button" onClick="excelResult()">수료결과보고서</button>';
        }
	...
	contents += '<th style="width:50px;">직책</th>';
	contents += '<th style="width:50px;">지역</th>';
