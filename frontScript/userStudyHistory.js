                        ...
                        if (data.testStatus == 'Y' || data.testStatus == 'C' || data.testStatus == 'V') {
                            if (data.testStatus == 'Y' || data.testStatus == 'V') {
                                ...
                                if(data.companyCode == '5088213174') {
                                    testLink = '';
                                    testStatus = '<strong class="blue">응시 완료</strong>';
                                } else if (data.resultView == 'Y') { // 채점 완료 상태에서만 결과 보여줌
                                    testLink = 'onClick="resultAct(\'test\',\'' + contentsCode + '\',' + lectureOpenSeq + ',\'final\')"';전
                ...
                $.each(data.progress, function () {
                    ...
                    if (totalCount != 0) {
                        ...
                        if (data.nowTime.substr(0, 10) > data.lectureReStudy) {
                            ...
                            //console.log(lectureOpenSeq);
                            studyDetails += '<button type="button" title="수강하기" onclick="studyPop(\'' + this.player + '\',\'' + ContentsCode + '\',\'' + this.chapter + '\',\'' + lectureOpenSeq + '\')"><img src="../images/study/btn_study.png" /></button>';
                        }
                        studyDetails += '</td>';
                        studyDetails += '</tr>';
                        //}
