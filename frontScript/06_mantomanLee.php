...
<script type="text/javascript" src="../frontScript/mantomanNew.js?ver=<?=date(ymdhis)?>"></script>
<script type="text/javascript" src="../frontScript/mantomanListNew.js?ver=<?=date(ymdhis)?>"></script>
<script type="text/javascript" src="../frontScript/mantomanAdminWriteNew.js?ver=<?=date(ymdhis)?>"></script>
<script type="text/javascript" src="../frontScript/mantomanViewNew.js?ver=<?=date(ymdhis)?>"></script>
</head>
