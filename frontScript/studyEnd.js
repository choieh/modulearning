...
function listAct(page){
	...
	if(loginUserLevel != 8) {
		...
		contents += '<th style="width:120px;">수강확인증</th>';
		...
		if (totalCount != 0){
			...
			$.each(data.study, function(){
					...
					$.each(this.company, function(){
						...
						// 수강인원
						lists += '<td>환급 : '+this.studyCount+'<br />비환급(평가없음) : '+this.studyBeCount3+'<br />비환급(평가있음) : '+this.studyBeCount5+'<br />수강연동 : '+this.studyBeCount8+'</td>';
						...
						if(loginUserLevel <= 4) { // 관리자 접근시
							...
							if(this.studyBeCount5 != 0) {
								...
								//수강확인증 추가(영업자 요청) 20200319 이화랑
								lists += '<td><button style="font-size:11px;" onClick="window.open(\'certificateClass.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=DM5PRA\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(어린이집)</button>';
								//수강확인증(비환급/공통) 추가(영업자 요청) 2020-06-26 이화랑
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateClass.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(공통)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateClass.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">환급과정</button></td>';
								//교육이수증
								lists += '<td><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsName=개인정보\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(어린이)</button>';
								...
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=D1BY70\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(성희롱예방1)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=FG0SF4\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(성희롱예방4)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=DM5PRA\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(어린이집16)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsName=감정노동자\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(감정노동자)</button>';
								...
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsName=노인학대\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(노인학대)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=SRC0LS\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(의료인증)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=WNL1KH\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(급성기)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=L1FTV3\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(병원종사자6)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=0SO08J\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(통합법정1)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=OO1SF9\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(통합법정2)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=Q7TQ2C\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급<br>(공공의료기관)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&contentsCode=UGCNND\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급<br>(법정의무)</button>';
								
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">개인(환급)</button>';
								//영유아 보육교사 관련 교육이수증 버튼 추가 20191212 이화랑
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificateStudy4.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1&sort02=lecture1001\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">개인(환급)<br>(영유아 보육교사)</button>';

								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateStudy2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&date=1\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">경비(1개월)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateStudy2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&date=2\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">경비(2개월)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateStudy2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&total=Y\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">경비(통합)</button></td>';

								//수료증
								lists += '<td style="vertical-align:top;"><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&contentsName=개인정보\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(개인정보)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsName=괴롭힘\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(괴롭힘금지)</button>';
								...
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=D1BY70\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(성희롱예방1)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=FG0SF4\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(성희롱예방4)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=DM5PRA\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(어린이집16)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsName=감정노동자\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(감정노동자)</button>';
								lists += '<br /><button style="font-size:9px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsName=아동학대\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급<br/>(아동학대 신고의무자)</button>';
								...
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsName=퇴직\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(퇴직연금)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsName=노인학대\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(노인학대)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=SRC0LS\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(의료인증)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=WNL1KH\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(급성기)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=L1FTV3\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(병원종사자6)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=0SO08J\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(통합법정1)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=OO1SF9\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(통합법정2)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=Q7TQ2C\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급<br>(공공의료기관)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsCode=UGCNND\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급<br>(법정의무)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5&contentsName=메타교육\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급<br>(메타교육)</button>';//메타교육(비환급) 버튼 추가 2020-06-02
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificate.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">개인(환급)</button>';
								//영유아 보육교사 관련 수료증 버튼 추가 20191212 이화랑
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1&sort02=lecture1001\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">개인(환급)<br>(영유아 보육교사)</button>';
								lists += '<br/><button style="font-size:11px;" onClick="window.open(\'certificate3.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&contentsCode=MACI1K\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">개인(비환급)<br>(영유아 보육교사)</button>';
								lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateAll.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&type=all\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(all)</button>';
								//lists += '<br /><button onClick="window.open(\'certificate2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">대표(환급)</button></td>';

								//수료결과보고서
								lists += '<td><button onClick="window.open(\'resultDoc.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1\',\'수료증\',\'width=820, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">환급과정만</button>&nbsp;';
								lists += '<br /><button onClick="window.open(\'resultDoc.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&serviceTypeA=5\',\'수료증\',\'width=820, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급</button>';
								...
								if(loginUserID == 'leehr0523'){
									lists += '<br /><button onClick="window.open(\'resultDocument_test.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=1\',\'수료증\',\'width=820, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">전체(수정본)</button>';
								}
							...
							if(this.studyCount == 0) {
								...
								lists += '<td><button style="font-size:11px;" onClick="window.open(\'certificateAll.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&serviceType=3&type=all\',\'수료증\',\'width=740, height=900, menubar=no, status=no, titlebar=no, toolbar=no, scrollbars=yes, resizeable=no\',\'printPop\')">비환급(all)</button></td>';
								...
								if(this.studyEnd == 'Y') {
									...
									//이수증
									lists += '<td><button style="font-size:11px;" onClick="window.open(\'certificateStudy.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'\')">개인</button>';
									lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateStudy2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&date=1\')">경비(1개월)</button>';
									lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateStudy2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&date=2\')">경비(2개월)</button>';
									lists += '<br /><button style="font-size:11px;" onClick="window.open(\'certificateStudy2.php?lectureStart='+data.study[i].lectureStart+'&lectureEnd='+data.study[i].lectureEnd+'&companyCode='+this.companyCode+'&total=Y\')">경비(통합)</button></td>';									
									//수료증
