...
async function hrdCheckScore(types, contentsCode, lectureOpenSeq, chapter = 0, flag) {
    let eval_cd = '';
...
async function studyModal(obj, chapter) { // 모달 창 오픈
    ...
    // clearTimeout(progressTime);
    let initProgressTime = new Promise( (resolve, reject) => {
      progressTime = setTimeout(() => {
